...
formdiv+= '<li class="sss-form-control gfield "> <div class="sss-form-control-inner"> <div class="ginput_container"> <input class="medium" name="entry.'+duan+'" maxlength="220" id="email_addr" placeholder="Bạn Mua gì, SL Bao nhiêu?" value="" type="text"> </div> </div> </li> ';
